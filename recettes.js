...
function getInstructionsByRecipe(recipeName) {
  const recipes = {'dahl aux lentilles': ["Cuire les lentilles dans une grande casserole d'eau bouillante jusqu'à ce qu'elles soient tendres.",
  "Dans une grande poêle, faire chauffer un peu d'huile à feu moyen-élevé.",
  "Ajouter les oignons et faire revenir pendant environ 5 minutes, jusqu'à ce qu'ils soient tendres et légèrement dorés.",
  "Ajouter l'ail, le gingembre et le curry en poudre et faire cuire pendant 1-2 minutes, jusqu'à ce qu'il soit parfumé.",
  'Ajouter les tomates et faire cuire pendant 5 minutes de plus, en remuant de temps en temps.',
  'Ajouter les lentilles et le lait de coco, puis porter à ébullition.',
  "Réduire le feu et laisser mijoter pendant environ 10 minutes, jusqu'à ce que la sauce ait épaissi. Saler et poivrer au goût. Garnir de coriandre fraîche."],
 'salade de lentilles': ["Cuire les lentilles dans une grande casserole d'eau bouillante jusqu'à ce qu'elles soient tendres.",
  "Égoutter et rincer sous l'eau froide.",
  'Dans un grand bol, mélanger les lentilles cuites, les tomates, les oignons rouges, le concombre, la feta et la menthe.',
  'Arroser de vinaigrette et bien mélanger.'],
 'biryani aux lentilles': ["Faire chauffer un peu d'huile dans une grande poêle à feu moyen-élevé.",
  "Ajouter les oignons et faire revenir pendant environ 5 minutes, jusqu'à ce qu'ils soient tendres et légèrement dorés.",
  "Ajouter l'ail, le gingembre et le curry en poudre et faire cuire pendant 1-2 minutes, jusqu'à ce qu'il soit parfumé.",
  'Ajouter les tomates et faire cuire pendant 5 minutes de plus, en remuant de temps en temps.',
  'Ajouter les lentilles cuites, la cardamome, la cannelle et le cumin, puis bien mélanger.',
  "Dans une autre grande casserole, porter une grande quantité d'eau à ébullition.",
  "Ajouter le riz et cuire pendant environ 10 minutes, jusqu'à ce qu'il soit tendre mais encore légèrement ferme.",
  'Égoutter le riz et le remettre dans la casserole. Ajouter le mélange de lentilles et bien mélanger. Garnir de coriandre fraîche.'],
 'houmous': ["Dans un robot culinaire, mélanger les pois chiches, le tahini, le jus de citron, l'ail, l'huile d'olive et le paprika jusqu'à ce que le mélange soit lisse.",
  "Ajouter un peu d'eau pour obtenir la consistance désirée."],
 'falafels': ["Mixer des pois chiches cuits avec de l'ail, des oignons, de la coriandre, du cumin et de la farine.",
  "Former des boules et les faire frire dans de l'huile.",
  'Servir chaud avec de la sauce au yaourt ou du houmous.'],
 'curry de pois chiches': ["Faire revenir les oignons et l'ail dans de l'huile.",
  'Ajouter les épices et les pois chiches égouttés.',
  'Incorporer du lait de coco et laisser mijoter pendant 10 minutes.'],
 'moussaka végétarienne': ['Couper des aubergines et des courgettes en tranches et les faire griller.',
  "Faire revenir des oignons et de l'ail dans de l'huile.",
  'Ajouter des tomates en dés, du concentré de tomates, des épices et des lentilles préalablement cuites.',
  'Disposer les légumes grillés et la préparation de lentilles dans un plat allant au four.',
  'Recouvrir de béchamel et enfourner pendant 30 minutes.'],
 "caviar d'aubergines": ['Couper des aubergines en deux et les faire cuire au four.',
  "Récupérer la chair des aubergines et la mixer avec de l'ail, du jus de citron, du tahini et de l'huile d'olive.",
  'Servir frais avec du pain pita ou des légumes croquants.'],
 'ratatouille': ['Couper les légumes en dés.',
  "Faire revenir les légumes dans de l'huile d'olive.",
  "Ajouter du thym et de l'ail.",
  'Laisser mijoter pendant 20-30 minutes.'],
 'risotto aux champignons': ['Faire chauffer du bouillon de légumes.',
  'Faire revenir des champignons dans une poêle.',
  "Ajouter de l'oignon et de l'ail.",
  "Ajouter du riz et faire cuire en remuant jusqu'à ce qu'il devienne translucide.",
  "Ajouter une louche de bouillon et remuer jusqu'à absorption.",
  "Continuer jusqu'à ce que le riz soit cuit.",
  'Ajouter du fromage râpé et du beurre.',
  'Saler et poivrer.'],
 'tartines aux champignons': ['Faire griller du pain de campagne.',
  "Faire revenir des champignons dans de l'huile d'olive.",
  "Ajouter de l'ail et du persil.",
  'Disposer les champignons sur les tranches de pain grillé.',
  'Ajouter du fromage râpé.',
  "Passer au four jusqu'à ce que le fromage soit fondu."],
 'quiche aux champignons': ['Préchauffer le four à 180°C.',
  'Faire cuire une pâte brisée.',
  "Faire revenir des champignons dans de l'huile d'olive.",
  'Disposer les champignons sur la pâte.',
  'Battre des oeufs avec de la crème fraîche.',
  'Verser le mélange sur les champignons.',
  'Ajouter du fromage râpé.',
  'Enfourner pour 30 minutes.'],
 'spaghetti de courgettes': ['Faire des spaghettis de courgettes avec un spiraliseur.',
  "Faire revenir des tomates cerises dans de l'huile d'olive.",
  "Ajouter de l'ail et des herbes de Provence.",
  'Ajouter les spaghettis de courgettes et faire revenir pendant quelques minutes.',
  'Ajouter du fromage râpé.',
  'Saler et poivrer.'],
 'flans de courgettes': ['Préchauffer le four à 180°C.',
  "Faire cuire des courgettes coupées en dés dans de l'huile d'olive.",
  'Battre des oeufs avec de la crème fraîche.',
  "Mélanger les courgettes avec le mélange d'oeufs.",
  'Verser le mélange dans des ramequins.',
  'Enfourner pour 20-25 minutes.'],
 'salade de brocoli': ['Faire cuire des fleurettes de brocoli à la vapeur.',
  'Mélanger les fleurettes avec des tomates cerises et des oignons rouges.',
  'Ajouter de la vinaigrette.'],
 'tartes aux brocolis': ['Préchauffer le four à 180°C.',
  'Faire cuire des fleurettes de brocoli à la vapeur.',
  'Disposer les fleurettes sur une pâte brisée.',
  'Battre des oeufs avec de la crème fraîche.',
  'Verser le mélange sur la pâte et enfourner pendant 30 minutes à 180 degrés.'],
 'pâtes aux brocolis': ["Faire cuire les pâtes dans une casserole d'eau bouillante salée.",
 ...
 'tarte aux poireaux': ['Préchauffer le four à 180°C.',
 ...
 'fondue de poireaux': ['Couper les poireaux en rondelles et les laver.',
 ...
 'gratin de poireaux': ['Préchauffer le four à 180°C.',
 ...
 'couscous de chou-fleur': ['Cuire le chou-fleur au couscous.',
  'Faire revenir des légumes dans une poêle.',
  'Mélanger les légumes avec le chou-fleur.',
  'Ajouter des épices et de l’eau.',
  'Laisser mijoter jusqu’à ce que le couscous soit cuit.'],
 'curry de chou-fleur': ['Couper le chou-fleur en fleurettes.',
  'Faire revenir du gingembre et de l’ail dans une poêle.',
  'Ajouter le chou-fleur et faire revenir.',
  'Ajouter des épices et de la crème.',
  'Laisser mijoter jusqu’à ce que le chou-fleur soit tendre.'],
 'purée de chou-fleur': ['Cuire le chou-fleur à la vapeur.',
  'Mixer le chou-fleur cuit avec de la crème et du beurre.',
  'Ajouter des épices et de la noix de muscade.',
  'Réchauffer la purée au micro-ondes.',
  'Servir chaud.'],
 'frites de patates douces': ['Préchauffer le four à 200°C.',
 ...
 'curry de patates douces': ['Éplucher les patates douces et les couper en cubes.',
  'Faire revenir des oignons dans une poêle.',
  'Ajouter les patates douces et les épices.',
  'Verser de l’eau et laisser mijoter.',
  'Servir chaud.'],
 'soupe de patates douces': ['Éplucher les patates douces et les couper en morceaux.',
  'Faire revenir des oignons dans une casserole.',
  'Ajouter les patates douces et du bouillon.',
  'Laisser mijoter jusqu’à ce que les patates douces soient tendres.',
  'Mixer la soupe et ajouter de la crème.'],
 'sauté de tofu et légumes': ['Couper le tofu en cubes.',
  'Faire revenir des légumes dans une poêle.',
  'Ajouter le tofu et faire revenir.',
  'Ajouter des épices et du tamari.',
  'Servir chaud.'],
 'nouilles sautées au tofu': ['Cuire les nouilles selon les instructions.',
  'Faire revenir des légumes et du tofu dans une poêle.',
  'Ajouter les nouilles et des épices.',
  'Faire sauter le tout.',
  'Servir chaud.'],
 'curry de tofu': ['Couper le tofu en cubes.',
  'Faire revenir des oignons dans une poêle.',
  'Ajouter le tofu et des légumes.',
  'Ajouter du lait de coco et des épices.',
  'Laisser mijoter jusqu’à ce que le tout soit cuit.'],
 'salade de quinoa': ["Cuire le quinoa dans de l'eau bouillante salée pendant environ 15 minutes.",
  "Pendant ce temps, couper les tomates cerises en deux et émincer l'oignon rouge.",
  "Préparer la vinaigrette en mélangeant de l'huile d'olive, du vinaigre balsamique, du sel et du poivre.",
  "Une fois le quinoa cuit, le rincer à l'eau froide et l'égoutter.",
  "Mélanger le quinoa avec les tomates cerises, l'oignon rouge et la vinaigrette."],
 'curry de quinoa': ["Cuire le quinoa dans de l'eau bouillante salée pendant environ 15 minutes.",
  "Pendant ce temps, émincer l'oignon et couper les légumes en cubes.",
  "Dans une poêle, faire revenir l'oignon dans de l'huile d'olive.",
  'Ajouter les légumes et faire revenir pendant quelques minutes.',
  'Ajouter le quinoa cuit et le lait de coco, puis laisser mijoter à feu doux pendant environ 10 minutes.'],
 'bowl de quinoa': ["Cuire le quinoa dans de l'eau bouillante salée pendant environ 15 minutes.",
  ...
  "Faire chauffer un peu d'huile d'olive dans une poêle et y faire revenir les légumes pendant quelques minutes.",
  'Dans un bol, disposer le quinoa cuit, les légumes et les graines de sésame.',
  'Servir chaud.'],
 "curry d'épinards": ["Faire chauffer un peu d'huile d'olive dans une poêle.",
  "Ajouter les épinards et faire revenir jusqu'à ce qu'ils soient tombés.",
  'Ajouter le lait de coco, le curry et le sel.',
  'Laisser mijoter à feu doux pendant environ 10 minutes.',
  'Servir chaud.'],
 'tarte aux épinards': ['Préchauffer le four à 180°C.',
  "Dans un saladier, mélanger la farine, l'huile d'olive et l'eau jusqu'à obtenir une pâte.",
  'Abaisser la pâte et la disposer dans un moule à tarte.',
  "Faire revenir les épinards dans de l'huile d'olive pendant quelques minutes.",
  'Dans un autre saladier, battre les oeufs, le lait et le sel.'],
 'lasagne aux épinards': ['Préchauffer le four à 180°C.',
  "Dans une poêle, faire revenir l'oignon et l'ail dans de l'huile d'olive.",
  "Ajouter les épinards et faire revenir jusqu'à ce qu'ils soient tombés.",
  'Dans un plat à gratin, alterner des couches de lasagnes, de la sauce tomate, des épinards et de la béchamel.',
  'Enfourner pour environ 30 minutes.'],
 'fajitas aux poivrons': ["Faire revenir les poivrons et l'oignon dans l'huile pendant 5 minutes",
  ' Ajouter la sauce tomate, le cumin, le paprika et la coriandre',
  ' Laisser mijoter 10 minutes',
  ' Réchauffer les tortillas dans une poêle',
  ' Garnir les tortillas de la préparation'],
 'tarte aux poivrons': ['Faire cuire les poivrons au four pendant 10 minutes à 180°C',
  ' Les peler et les couper en lanières',
  ' Dans un bol, mélanger les œufs, la crème fraîche, le gruyère et les herbes de Provence',
  ' Étaler la pâte brisée dans un moule à tarte',
  ' Répartir les lanières de poivrons sur le fond de tarte',
  ' Verser le mélange œufs-crème-gruyère sur les poivrons',
  ' Enfourner la tarte pour 25 minutes à 180°C'],
 'poivrons farcis': ['Faire cuire le riz',
  ' Évider les poivrons',
  " Dans une poêle, faire revenir l'oignon et l'ail dans l'huile",
  ' Ajouter le riz cuit, les herbes de Provence et saler',
  ' Farcir les poivrons avec cette préparation',
  ' Les déposer dans un plat allant au four',
  ' Enfourner pour 20 minutes à 180°C'],
 'céleri-rave rôti': ['Éplucher le céleri-rave et le couper en cubes',
  " Dans un saladier, mélanger les cubes de céleri-rave avec de l'huile, du sel, du poivre et des herbes de Provence",
  ' Les disposer sur une plaque allant au four',
  ' Enfourner pour 25 minutes à 200°C'],
 'velouté de céleri-rave': ['Éplucher et couper en morceaux le céleri-rave et les pommes de terre',
  " Émincer l'oignon et l'ail",
  " Dans une casserole, faire revenir l'oignon et l'ail dans de l'huile",
  ' Ajouter le céleri-rave et les pommes de terre',
  ' Recouvrir de bouillon de légumes',
  ' Laisser cuire à feu doux pendant 25 minutes',
  ' Mixer la préparation avec la crème fraîche'],
 'salade de céleri-rave': ['Éplucher et râper le céleri-rave',
  ' Éplucher et couper en dés la pomme',
  " Émincer l'oignon rouge",
  ' Concasser les noix',
  " Dans un saladier, mélanger le céleri-rave, la pomme, l'oignon rouge et les noix",
  " Préparer une vinaigrette avec le vinaigre de cidre, l'huile et du sel",
  ' Ajouter la vinaigrette à la salade'],
 'carottes rôties au cumin': ['Éplucher et couper les carottes en bâtonnets',
  ' Les disposer sur une plaque allant au four',
  " Mélanger dans un bol l'huile, le cumin, du sel et du poivre",
  ' Verser cette préparation sur les carottes',
  ' Enfourner pour 25 minutes à 200°C'],
 'curry de carottes': ["Peler et émincer l'oignon, l'ail et le gingembre",
  " Faire revenir le tout dans l'huile",
  ' Ajouter les carottes coupées en rondelles et le curry',
  ' Mélanger et ajouter le lait de coco',
  " Laisser mijoter jusqu'à ce que les carottes soient cuites",
  ' Ajouter les pois chiches et laisser mijoter encore 5 minutes'],
 'tarte aux carottes': ['Préchauffer le four à 200°C',
  ' Etaler la pâte brisée dans un moule à tarte',
  ' Peler et râper les carottes',
  ' Les disposer sur la pâte',
  ' Dans un bol, battre les œufs avec la crème fraîche et le cumin',
  ' Verser cette préparation sur les carottes',
  ' Saupoudrer de gruyère râpé',
  ' Enfourner pour 30 minutes'],
 "haricots verts sautés à l'ail": ['Laver les haricots verts et les équeuter',
  " Les faire cuire 5 minutes dans une casserole d'eau bouillante salée",
  ' Les égoutter',
  " Dans une poêle, faire chauffer l'huile d'olive",
  " Ajouter l'ail émincé et les haricots verts",
  ' Faire sauter pendant 5 minutes',
  ' Saler et poivrer'],
 'salade de haricots verts': ['Laver les haricots verts et les équeuter',
  " Les faire cuire 5 minutes dans une casserole d'eau bouillante salée",
  " Les égoutter et les passer sous l'eau froide",
  ' Couper les tomates cerises en deux',
  " Émincer l'oignon rouge",
  " Dans un saladier, mélanger les haricots verts, les tomates cerises et l'oignon rouge",
  ' Ajouter la vinaigrette'],
 'gratin de haricots verts': ['Préchauffer le four à 200°C',
  ' Laver les haricots verts et les équeuter',
  " Les faire cuire 5 minutes dans une casserole d'eau bouillante salée",
  ' Les égoutter',
  " Dans une casserole, faire chauffer la crème fraîche avec l'ail émincé et le gruyère râpé",
  ' Ajouter les haricots verts et mélanger',
  ' Beurrer un plat à gratin et y verser la préparation',
  ' Enfourner pour 20 minutes'],
 "soupe à l'oignon": ['Éplucher et émincer les oignons',
  ...
  ' Couper la baguette en tranches et les faire griller',
  ' Répartir la soupe dans des bols allant au four',
  ' Déposer une tranche de pain grillé sur chaque bol et saupoudrer de gruyère râpé',
 ...
 "tacos à l'avocat": ['Couper les tomates en petits dés.',
  ...
  'Saler à son goût.'],
 'tofu sauté aux noix de cajou': ['Couper le tofu en petits cubes.',
 ...
 'curry de légumes aux noix de cajou': ["Faire chauffer l'huile dans une grande poêle.",
 ...
 'salade de chou aux noix de cajou': ['Couper le chou en fines lanières.',
 ...
 'crème glacée à la banane': ['Éplucher les bananes et les couper en rondelles.',
 ...
 'bananes cuites au four avec du chocolat': ['Préchauffer le four à 180°C.',
 ...
 'pain à la banane': ['Préchauffer le four à 180°C.',
 ...
 'tarte aux pommes': ['Préchauffez le four à 180°C.',
 ...
 'compote de pommes': ['Pelez et coupez les pommes en petits morceaux.',
 ...
 'pommes caramélisées au four': ['Préchauffez le four à 180°C.',
 ...
 'tarte au citron': ['Préchauffez le four à 180°C.',
  'Étalez la pâte brisée dans un moule à tarte.',
 ...
 'sorbet au citron': ["Pelez les citrons et mixez-les avec le sucre et l'eau.",
 ...
 'gâteau au citron': ['Préchauffez le four à 180°C.',
 ...
 'brownies au chocolat': ['Faire fondre le beurre et le chocolat noir au bain-marie.',
  'Ajouter le sucre et mélanger.',
  'Ajouter la farine et mélanger.',
  'Ajouter les œufs et mélanger.',
  'Verser la pâte dans un moule beurré et enfourner pendant environ 25 minutes.'],
 'mousse au chocolat': ['Faire fondre le chocolat noir au bain-marie.',
 ...
 'gâteau au chocolat': ['Faire fondre le chocolat noir et le beurre au bain-marie.',
  'Ajouter le sucre et mélanger.',
  'Ajouter la farine et mélanger.',
  'Ajouter les œufs et mélanger.',
  'Verser la pâte dans un moule beurré et enfourner pendant environ 30 minutes.'],
 'tarte aux framboises': ['Étaler la pâte sablée dans un moule à tarte beurré.',
 ...
 'sorbet aux framboises': ['Mixer les framboises avec le sucre et l’eau.',
  'Verser la préparation dans une sorbetière et turbiner pendant environ 30 minutes.'],
 'clafoutis aux framboises': ['Beurrer un plat allant au four.',
 ...
 'sauce tomate maison': ['Peler et hacher finement l’oignon et l’ail.',
 ...
 'tarte à la tomate': ['Préchauffer le four à 180°C.',
 ...
 'salade de tomates et mozzarella': ['Couper les tomates et la mozzarella en tranches.',
  'Disposer les tranches de tomates et de mozzarella en alternance sur un plat.',
  'Parsemer de feuilles de basilic.',
  'Arroser d’un filet d’huile d’olive.',
  'Saler et poivrer.'],
 'purée de pommes de terre': ['Peler les pommes de terre et les couper en morceaux.',
  ...
  'Saler et poivrer.'],
 'curry de pommes de terre et épinards': ['Peler et hacher finement l’oignon et l’ail.',
 ...
 'riz sauté aux légumes': ['Cuire le riz selon les instructions sur l’emballage.',
  ...
  'Servir chaud.'],
 'riz au lait végétal': ['Cuire le riz selon les instructions sur l’emballage.',
  ...
  'Servir froid.'],
 'bol de riz aux haricots noirs': ['Faire cuire le riz selon les instructions sur le paquet.',
 ...
 "spaghetti à l'ail et à l'huile d'olive": ['Faire cuire les spaghetti selon les instructions sur le paquet.',
 ...
 'lasagne aux légumes': ['Faire cuire les lasagnes selon les instructions sur le paquet.',
 ...
 'salade de pâtes et légumes grillés': ['Faire cuire les pâtes selon les instructions sur le paquet.',
 ...
 'omelette aux champignons': ['Faire chauffer l’huile d’olive dans une poêle.',
 ...
 'quiche aux épinards': ['Préchauffer le four à 180°C.',
 ...
 'huevos rancheros': ['Faire chauffer l’huile d’olive dans une poêle.',
 ...
 'pizza au fromage': ['Préchauffer le four à 220°C.',
 ...
 'fondue de fromage': ['Frotter le fond du caquelon avec une gousse d’ail.',
 ...
 'macaroni au fromage': ['Faire cuire les macaronis selon les instructions sur le paquet.',
