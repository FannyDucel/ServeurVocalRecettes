...
function getInstructionsByRecipe(recipeName) {
  const recipes = {'lentil dahl': ['Cook the lentils in a large pot of boiling water until tender. In a large pan, heat a little oil over medium-high heat.',
  'Add the onions and sauté for about 5 minutes, until tender and lightly golden.',
  ...
  'Add the lentils and coconut milk, then bring to a boil. Reduce the heat and simmer for about 10 minutes, until the sauce has thickened. Season with salt and pepper to taste. Garnish with fresh cilantro.'],
 'lentil salad': ['Cook the lentils in a large pot of boiling water until tender',
  ' Drain and rinse under cold water',
  ' In a large bowl, mix the cooked lentils, tomatoes, red onions, cucumber, feta cheese, and mint',
  ' Drizzle with dressing and toss well'],
 'lentil biryani': ['Heat a little oil in a large pan over medium-high heat.',
  'Add the onions and sauté for about 5 minutes, until tender and lightly golden.',
  'Add the garlic, ginger, and curry powder and cook for 1-2 minutes, until fragrant.',
  'Add the tomatoes and cook for another 5 minutes, stirring occasionally.',
  'Add the cooked lentils, cardamom, cinnamon, and cumin, then mix well.',
  'In another large pot, bring a large amount of water to a boil. Add the rice and cook for about 10 minutes, until tender but still slightly firm.',
  ' Drain the rice and return it to the pot. Add the lentil mixture and mix well. Garnish with fresh cilantro.'],
 'hummus': ['In a food processor, mix the chickpeas, tahini, lemon juice, garlic, olive oil, and paprika until smooth.',
  'Add a little water to achieve the desired consistency.'],
 'falafels': ['Blend cooked chickpeas with garlic, onions, coriander, cumin, and flour.',
  'Form balls and fry in oil.',
  'Serve hot with yogurt sauce or hummus.'],
 'chickpea curry': ['Sauté onions and garlic in oil.',
  'Add spices and drained chickpeas.',
  'Stir in coconut milk and simmer for 10 minutes.'],
 'vegetarian moussaka': ['Cut eggplants and zucchinis into slices and grill them.',
  'Sauté onions and garlic in oil.',
  'Add diced tomatoes, tomato paste, spices, and pre-cooked lentils.',
  'Arrange the grilled vegetables and lentil mixture in an oven-proof dish.',
  'Cover with béchamel sauce and bake for 30 minutes.'],
 'eggplant caviar': ['Cut eggplants in half and bake them in the oven.',
  'Scoop out the eggplant flesh and mix it with garlic, lemon juice, tahini, and olive oil.',
  'Serve chilled with pita bread or crunchy vegetables.'],
 'ratatouille': ['Dice the vegetables.',
  'Sauté the vegetables in olive oil.',
  'Add thyme and garlic.',
  'Simmer for 20-30 minutes.'],
 'mushroom risotto': ['Heat vegetable broth.',
  'Sauté mushrooms in a pan.',
  'Add onion and garlic.',
  'Add rice and cook, stirring, until it becomes translucent.',
  'Add a ladle of broth and stir until absorbed.',
  'Continue until rice is cooked.',
  'Add grated cheese and butter.',
  'Season with salt and pepper.'],
 'mushroom toast': ['Toast slices of country bread.',
  'Sauté mushrooms in olive oil.',
  'Add garlic and parsley.',
  'Arrange mushrooms on top of the toasted bread.',
  'Add grated cheese.',
  'Bake in the oven until cheese is melted.'],
 'mushroom quiche': ['Preheat the oven to 180°C.',
  'Bake a pastry shell.',
  'Sauté mushrooms in olive oil.',
  'Place mushrooms on top of the pastry.',
  'Beat eggs with crème fraîche.',
  'Pour the mixture over the mushrooms.',
  'Add grated cheese.',
  'Bake for 30 minutes.'],
 'zucchini spaghetti': ['Make zucchini spaghetti with a spiralizer.',
  'Sauté cherry tomatoes in olive oil.',
  'Add garlic and herbs de Provence.',
  'Add zucchini spaghetti and sauté for a few minutes.',
  'Add grated cheese.',
  'Season with salt and pepper.'],
 'zucchini flan': ['Preheat the oven to 180°C.',
  'Cook diced zucchini in olive oil.',
  'Beat eggs with crème fraîche.',
  'Mix zucchini with egg mixture.',
  'Pour mixture into ramekins.',
  'Bake for 20-25 minutes.'],
 'broccoli salad': ['Steam broccoli florets.',
  'Mix florets with cherry tomatoes and red onions.',
  'Add vinaigrette.'],
 'broccoli tarts': ['Preheat the oven to 180°C.',
  'Steam broccoli florets.',
  'Arrange florets on top of a pastry shell.',
  'Beat eggs with crème fraîche.',
  'Pour the mixture over the pastry and bake for 30 minutes at 180°C.'],
 'broccoli pasta': ['Cook the pasta in a pot of salted boiling water.',
 ...
 'leek tart': ['Preheat the oven to 180°C.',
 ...
 'leek fondue': ['Slice the leeks and wash them.',
  ...
  'Season with salt and pepper.'],
 'leek gratin': ['Preheat the oven to 180°C.',
 ...
 'cauliflower couscous': ['Cook the cauliflower like couscous.',
  'Sauté vegetables in a pan.',
  'Mix the vegetables with the cauliflower.',
  'Add spices and water.',
  'Simmer until the couscous is cooked.'],
 'cauliflower curry': ['Cut the cauliflower into florets.',
  'Sauté ginger and garlic in a pan.',
  'Add the cauliflower and sauté.',
  'Add spices and cream.',
  'Simmer until the cauliflower is tender.'],
 'cauliflower mash': ['Steam the cauliflower.',
  'Blend the cooked cauliflower with cream and butter.',
  'Add spices and nutmeg.',
  'Reheat the puree in the microwave.',
  'Serve hot.'],
 'sweet potato fries': ['Preheat the oven to 200°C.',
 ...
 'sweet potato curry': ['Peel the sweet potatoes and cut them into cubes.',
  'Sauté onions in a pan.',
  'Add the sweet potatoes and spices.',
  'Pour in water and simmer.',
  'Serve hot.'],
 'sweet potato soup': ['Peel and chop the sweet potatoes.',
  'Sauté onions in a saucepan.',
  'Add the sweet potatoes and broth.',
  'Let simmer until the sweet potatoes are tender.',
  'Blend the soup and add cream.'],
 'tofu and vegetable stir-fry': ['Cut the tofu into cubes.',
  'Sauté vegetables in a frying pan.',
  'Add the tofu and sauté.',
  'Add spices and tamari.',
  'Serve hot.'],
 'tofu stir-fry noodles': ['Cook noodles according to instructions.',
  'Sauté vegetables and tofu in a frying pan.',
  'Add the noodles and spices.',
  'Stir-fry everything.',
  'Serve hot.'],
 'tofu curry': ['Cut the tofu into cubes.',
  'Sauté onions in a frying pan.',
 ...
 'quinoa salad': ['Cook quinoa in salted boiling water for about 15 minutes.',
  'Meanwhile, cut cherry tomatoes in half and thinly slice red onion.',
  'Prepare the vinaigrette by mixing olive oil, balsamic vinegar, salt, and pepper.',
  'Once the quinoa is cooked, rinse it with cold water and drain it.',
  'Mix the quinoa with cherry tomatoes, red onion, and vinaigrette.'],
 'quinoa curry': ['Cook quinoa in salted boiling water for about 15 minutes.',
  'Meanwhile, thinly slice the onion and cube the vegetables.',
  'In a frying pan, sauté the onion in olive oil.',
  'Add the vegetables and sauté for a few minutes.',
  'Add the cooked quinoa and coconut milk, then simmer over low heat for about 10 minutes.'],
 'quinoa bowl': ['Cook quinoa in salted boiling water for about 15 minutes.',
  'Meanwhile, cube the vegetables.',
  'Heat some olive oil in a frying pan and sauté the vegetables for a few minutes.',
  'In a bowl, arrange the cooked quinoa, vegetables, and sesame seeds.',
  'Serve hot.'],
 'spinach curry': ['Heat some olive oil in a frying pan.',
  'Add the spinach and sauté until wilted.',
  'Add coconut milk, curry, and salt.',
  'Simmer over low heat for about 10 minutes.',
  'Serve hot.'],
 'spinach tart': ['Preheat the oven to 180°C.',
  'In a bowl, mix the flour, olive oil, and water until obtaining a dough.',
  'Roll out the dough and place it in a pie dish.',
  'Sauté the spinach in olive oil for a few minutes.',
  'In another bowl, beat the eggs, milk, and salt.'],
 'spinach lasagna': ['Preheat the oven to 180°C.',
  'In a frying pan, sauté the onion and garlic in olive oil.',
  'Add the spinach and sauté until wilted.',
  'In a gratin dish, alternate layers of lasagna, tomato sauce, spinach, and béchamel.',
  'Bake for about 30 minutes.'],
 'bell pepper fajitas': ['Sauté peppers and onion in oil for 5 minutes',
  ' Add tomato sauce, cumin, paprika, and coriander',
  ' Let simmer for 10 minutes',
  ' Warm the tortillas in a frying pan',
  ' Fill the tortillas with the mixture'],
 'bell pepper tart': ['Cook the peppers in the oven for 10 minutes at 180°C',
  ' Peel and cut them into strips',
  ' In a bowl, mix the eggs, sour cream, gruyere cheese, and Provence herbs',
  ' Put this mixture in the bell peppers and bake for 25 minutes at 200°C'],
 'stuffed bell peppers': ['Cook the rice',
  ' Hollow out the peppers',
  ' In a pan, sauté the onion and garlic in oil',
  ' Add the cooked rice, herbs of Provence and salt',
  ' Stuff the peppers with this mixture',
  ' Place them in an oven dish',
  ' Bake for 20 minutes at 180°C'],
 'roasted celeriac': ['Peel and cut the celeriac into cubes',
  ' In a bowl, mix the celeriac cubes with oil, salt, pepper and herbs of Provence',
  ' Arrange them on an oven tray',
  ' Bake for 25 minutes at 200°C'],
 'celeriac soup': ['Peel and cut the celeriac and potatoes into pieces',
  ' Slice the onion and garlic',
  ' In a pot, sauté the onion and garlic in oil',
  ' Add the celeriac and potatoes',
  ' Cover with vegetable broth',
  ' Let simmer on low heat for 25 minutes',
  ' Blend the mixture with the sour cream'],
 'celeriac salad': ['Peel and grate the celeriac',
  ' Peel and dice the apple',
  ' Slice the red onion',
  ' Crush the walnuts',
  ' In a bowl, mix the celeriac, apple, red onion and walnuts',
  ' Prepare a dressing with cider vinegar, oil and salt',
  ' Add the dressing to the salad'],
 'cumin roasted carrots': ['Peel and cut the carrots into sticks',
  ' Arrange them on an oven tray',
  ' Mix in a bowl oil, cumin, salt and pepper',
  ' Pour this mixture over the carrots',
  ' Bake for 25 minutes at 200°C'],
 'carrot curry': ['Peel and slice the onion, garlic and ginger',
  ' Sauté everything in oil',
  ' Add the carrots sliced into rounds and the curry',
  ' Mix and add the coconut milk',
  ' Let simmer until the carrots are cooked',
  ' Add the chickpeas and let simmer for another 5 minutes'],
 'carrot tart': ['Preheat the oven to 200°C',
  ' Roll out the shortcrust pastry in a pie dish',
  ' Peel and grate the carrots',
  ' Arrange them on the pastry',
  ' In a bowl, beat the eggs with the sour cream and cumin',
  ' Pour this mixture over the carrots',
  ' Sprinkle with grated gruyere',
  ' Bake for 30 minutes'],
 'garlic sautéed green beans': ['Wash and trim the green beans',
  ' Cook them for 5 minutes in a pot of salted boiling water',
  ' Drain them',
  ' In a pan, heat olive oil',
  ' Add minced garlic and green beans',
  ' Sauté for 5 minutes',
  ' Salt and pepper'],
 'green bean salad': ['Wash and trim the green beans',
  ' Cook them for 5 minutes in a pot of salted boiling water',
  ' Drain them and rinse them under cold water',
  ' Cut the cherry tomatoes in half',
  ' Slice the red onion',
  ' In a bowl, mix the green beans, cherry tomatoes and red onion',
  ' Add the dressing'],
 'green bean gratin': ['Preheat the oven to 200°C',
  ' Wash and trim the green beans',
  ' Cook them for 5 minutes in a pot of salted boiling water',
  ' Drain them',
  ' In a pot, heat the sour cream with minced garlic and grated gruyere',
  ' Add the green beans and mix',
  ' Butter a gratin dish and pour the mixture into it',
  ' Bake for 20 minutes'],
 'onion soup': ['Peel and chop the onions',
  ' Sauté them in a pot with a little olive oil',
  ' Add thyme and bay leaves',
  ' Pour in the vegetable broth and white wine',
  ' Let simmer for 20 minutes',
  ' Preheat the oven to 180°C',
  ' Cut the baguette into slices and toast them',
  ' Pour the soup into oven-safe bowls',
  ' Place a slice of toasted bread on top of each bowl and sprinkle with grated Gruyere cheese',
  ' Bake for 10 minutes'],
 ...
 'avocado tacos': ['Dice the tomatoes into small pieces.',
  ...
  'Salt to taste.'],
 'stir-fried tofu with cashews': ['Cut the tofu into small cubes.',
 ...
 'vegetable curry with cashews': ['Heat oil in a large pan.',
 ...
 'baked bananas with chocolate': ['Preheat the oven to 180°C.',
 ...
 'banana bread': ['Preheat the oven to 180°C.',
 ...
 'apple pie': ['Preheat the oven to 180°C.',
 ...
 'apple compote': ['Peel and dice the apples.',
 ...
 'baked caramelized apples': ['Preheat the oven to 180°C.',
 ...
 'lemon pie': ['Preheat the oven to 180°C.',
  'Roll out the shortcrust pastry in a tart pan.',
 ...
 'chocolate brownies': ['Melt the butter and dark chocolate in a double boiler.',
  'Add the sugar and mix.',
  'Add the flour and mix.',
  'Add the eggs and mix.',
  'Pour the batter into a buttered mold and bake for about 25 minutes.'],
 'chocolate mousse': ['Melt dark chocolate in a bain-marie.',
 ...
 'chocolate cake': ['Melt dark chocolate and butter in a bain-marie.',
  'Add sugar and mix.',
  'Add flour and mix.',
  'Add eggs and mix.',
  'Pour the batter into a buttered cake pan and bake for about 30 minutes.'],
 'raspberry tart': ['Roll out the shortcrust pastry in a buttered tart pan.',
 ...
 'tomato pie': ['Preheat the oven to 180°C.',
 ...
 'tomato and mozzarella salad': ['Slice the tomatoes and mozzarella cheese.',
  'Arrange the tomato and mozzarella slices alternately on a plate.',
  'Sprinkle with basil leaves.',
  'Drizzle with olive oil.',
  'Season with salt and pepper.'],
 'mashed potatoes': ['Peel and chop the potatoes into small pieces.',
  ...
  'Add butter and milk.',
  'Season with salt and pepper.'],
 'potato and spinach curry': ['Peel and finely chop the onion and garlic.',
 ...
 'stir-fried rice with vegetables': ['Cook the rice according to package instructions.',
  ...
  'Serve hot.'],
 'rice with vegetable milk': ['Cook the rice according to package instructions.',
  ...
  'Serve cold.'],
 'rice bowl with black beans': ['Cook the rice according to package instructions.',
 ...
 'spaghetti with garlic and olive oil': ['Cook the spaghetti according to package instructions.',
 ...
 'vegetable lasagne': ['Cook the lasagna noodles according to package instructions.',
 ...
 'pasta salad with grilled vegetables': ['Cook the pasta according to package instructions.',
 ...
 'mushroom omelette': ['Heat olive oil in a pan.',
 ...
 'spinach quiche': ['Preheat oven to 180°C.',
 ...
 'huevos rancheros': ['Heat olive oil in a pan.',
 ...
 'cheese pizza': ['Preheat oven to 220°C.',
 ...
 'cheese fondue': ['Rub the bottom of the fondue pot with a clove of garlic.',
  'Pour white wine into the fondue pot and heat.',
  'Add the cheese and stir until melted.',
  'Add kirsch and stir.',
  'Dip pieces of bread in the fondue.'],
 'macaroni and cheese': ['Cook macaroni according to package instructions.',
