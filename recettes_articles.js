...
function getIngredientsByRecipe(recipeName) {
  const recipes = {
    'un dahl aux lentilles': ['lentilles', 'oignons', 'ail', 'gingembre', 'curry en poudre', 'tomates en dés', 'lait de coco', 'coriandre'],
    'une salade de lentilles': ['lentilles', 'tomates', 'oignons rouges', 'concombre', 'feta', 'menthe'],
    'un biryani aux lentilles': ['lentilles', 'oignons', 'ail', 'gingembre', 'tomates', 'curry en poudre', 'coriandre', 'cardamome', 'cannelle', 'cumin', 'riz basmati'],
    'du houmous': ['pois chiches', 'tahini', 'jus de citron', 'ail', 'huile d olive', 'paprika'],
    'des falafels': ['pois chiches', 'oignons', 'ail', 'coriandre', 'cumin', 'farine', 'levure chimique'],
    'un curry de pois chiches': ['pois chiches', 'oignons', 'ail', 'gingembre', 'curry en poudre', 'tomates en dés', 'lait de coco', 'coriandre'],
    'une moussaka végétarienne': ['aubergines', 'pommes de terre', 'oignons', 'ail', 'coulis de tomate', 'lait', 'farine', 'fromage râpé'],
    "du caviar d'aubergines": ['aubergines', 'ail', 'jus de citron', 'tahini', 'huile d olive', 'cumin'],
    'une ratatouille': ['aubergines', 'courgettes', 'poivrons', 'oignons', 'ail', 'coulis de tomate', 'thym', 'persil'],
    'un risotto aux champignons': ['riz arborio', 'champignons', 'oignons', 'ail', 'bouillon de légumes', 'parmesan', 'beurre'],
    'des tartines aux champignons': ['champignons', 'ail', 'persil', 'pain de campagne', 'fromage frais'],
    'une quiche aux champignons': ['pâte feuilletée', 'champignons', 'oignons', 'ail', 'crème fraîche', 'œufs', 'fromage râpé'],
    'des spaghetti de courgettes': ['courgettes', 'ail', 'huile d olive', 'tomates cerises', 'basilic', 'parmesan'],
    'des flans de courgettes': ['courgettes', 'oignons', 'ail', 'œufs', 'crème fraîche', 'fromage râpé'],
    'une salade de brocoli': ['brocoli', 'oignons rouges', 'raisins secs', 'noix', 'vinaigrette'],
    'des tartes aux brocolis': ['pâte feuilletée', 'brocoli', 'oignons', 'ail', 'crème fraîche', 'œufs', 'fromage râpé'],
    'des pâtes aux brocolis': ['pâtes', 'brocolis', 'huile d\'olive', 'ail', 'parmesan'],
    'une tarte aux poireaux': ['pâte feuilletée', 'poireaux', 'crème fraîche', 'œufs', 'fromage râpé'],
    'une fondue de poireaux': ['poireaux', 'beurre', 'crème fraîche', 'fromage râpé'],
    'un gratin de poireaux': ['poireaux', 'beurre', 'farine', 'lait', 'fromage râpé'],
    'un couscous de chou-fleur': ['chou-fleur', 'huile d\'olive', 'cumin', 'coriandre', 'oignon', 'raisins secs'],
    'un curry de chou-fleur': ['chou-fleur', 'huile d\'olive', 'oignon', 'ail', 'gingembre', 'curry', 'lait de coco'],
    'une purée de chou-fleur': ['chou-fleur', 'pommes de terre', 'beurre', 'lait'],
    'des frites de patates douces': ['patates douces', 'huile d\'olive', 'paprika', 'sel'],
    'un curry de patates douces': ['patates douces', 'oignon', 'ail', 'gingembre', 'curry', 'lait de coco'],
    'une soupe de patates douces': ['patates douces', 'oignon', 'ail', 'gingembre', 'bouillon de légumes', 'lait de coco'],
    'un sauté de tofu et légumes': ['tofu', 'légumes (carottes, poivrons, courgettes)', 'sauce soja', 'huile d\'olive', 'ail'],
    'des nouilles sautées au tofu': ['nouilles', 'tofu', 'sauce soja', 'ail', 'oignon', 'huile'],
    'un curry de tofu': ['tofu', 'lait de coco', 'curry', 'oignon', 'ail', 'gingembre', 'huile', 'coriandre'],
    'une salade de quinoa': ['quinoa', 'concombre', 'tomate', 'poivron', 'oignon rouge', 'feta', 'menthe', 'persil', 'citron', 'huile'],
    'un curry de quinoa': ['quinoa', 'lait de coco', 'curry', 'pois chiches', 'épinards', 'oignon', 'ail', 'gingembre', 'huile'],
    'un bowl de quinoa': ['quinoa', 'pois chiches', 'concombre', 'carotte', 'avocat', 'feta', 'menthe', 'persil', 'citron', 'huile'],
    "un curry d'épinards": ['épinards', 'lait de coco', 'curry', 'pois chiches', 'oignon', 'ail', 'gingembre', 'huile'],
    'une tarte aux épinards': ['pâte brisée', 'épinards', 'oignon', 'ail', 'œufs', 'crème fraîche', 'gruyère', 'noix de muscade'],
    'une lasagne aux épinards': ['lasagnes', 'épinards', 'oignon', 'ail', 'béchamel', 'gruyère', 'huile'],
    'des fajitas aux poivrons': ['tortillas', 'poivrons', 'oignon', 'sauce tomate', 'cumin', 'paprika', 'coriandre', 'huile'],
    'une tarte aux poivrons': ['pâte brisée', 'poivrons', 'œufs', 'crème fraîche', 'gruyère', 'herbes de Provence'],
    'des poivrons farcis': ['poivrons', 'riz', 'oignon', 'ail', 'herbes de Provence', 'huile'],
    'du céleri-rave rôti': ['céleri-rave', 'huile', 'sel', 'poivre', 'herbes de Provence'],
    'un velouté de céleri-rave': ['céleri-rave', 'pommes de terre', 'oignon', 'ail', 'bouillon de légumes', 'crème fraîche', 'huile'],
    'une salade de céleri-rave': ['céleri-rave', 'pomme', 'oignon rouge', 'noix', 'vinaigre de cidre', 'huile'],
    'des carottes rôties au cumin': ['carottes', 'cumin', 'huile', 'sel', 'poivre'],
    'un curry de carottes': ['carottes', 'lait de coco', 'curry', 'pois chiches', 'oignon', 'ail', 'gingembre', 'huile'],
    'une tarte aux carottes': ['pâte brisée', 'carottes', 'œufs', 'crème fraîche', 'gruyère', 'cumin'],
    "des haricots verts sautés à l'ail": ["haricots verts", "ail", "huile d'olive", "sel", "poivre"],
    "une salade de haricots verts": ["haricots verts", "tomates cerises", "oignon rouge", "vinaigrette"],
    "un gratin de haricots verts": ["haricots verts", "crème fraîche", "gruyère râpé", "ail", "beurre", "sel", "poivre"],
    "une soupe à l'oignon": ["oignons", "bouillon de légumes", "vin blanc", "thym", "laurier", "gruyère râpé", "baguette"],
    "une tarte aux oignons": ["pâte feuilletée", "oignons", "crème fraîche", "œufs", "beurre", "huile d'olive", "thym", "sel", "poivre"],
    "une poêlée d'oignons": ["oignons", "huile d'olive", "miel", "vinaigre balsamique"],
    "du guacamole": ["avocats", "citron vert", "tomate", "oignon rouge", "coriandre", "sel"],
    "une salade d'avocat et de mangue": ["mangue", "avocat", "concombre", "oignon rouge", "coriandre", "vinaigrette"],
    "des tacos à l'avocat": ["avocats", "tortillas", "maïs", "tomates", "oignon rouge", "coriandre", "citron vert"],
    "un sauté de tofu aux noix de cajou": ["tofu", "noix de cajou", "oignon", "ail", "gingembre", "sauce soja", "miel", "huile de sésame"],
...
function getTimeByRecipe(recipeName) {
  const recipes = {
    'un dahl aux lentilles': '40 minutes',
    'une salade de lentilles': '20 minutes',
    'un biryani aux lentilles': '60 minutes',
    'du houmous': '15 minutes',
    'des falafels': '30 minutes',
    'un curry de pois chiches': '40 minutes',
...
function getInstructionsByRecipe(recipeName) {
  const recipes = {
    ...
    'un biryani aux lentilles': ['Faire chauffer un peu d\'huile dans une grande poêle à feu moyen-élevé. Ajouter les oignons et faire revenir pendant environ 5 minutes, jusqu\'à ce qu\'ils soient tendres et légèrement dorés. Ajouter l\'ail, le gingembre et le curry en poudre et faire cuire pendant 1-2 minutes, jusqu\'à ce qu\'il soit parfumé. Ajouter les tomates et faire cuire pendant 5 minutes de plus, en remuant de temps en temps. Ajouter les lentilles cuites, la cardamome, la cannelle et le cumin, puis bien mélanger. Dans une autre grande casserole, porter une grande quantité d\'eau à ébullition. Ajouter le riz et cuire pendant environ 10 minutes, jusqu\'à ce qu\'il soit tendre mais encore légèrement ferme. Égoutter le riz et le remettre dans la casserole. Ajouter le mélange de lentilles et bien mélanger. Garnir de coriandre fraîche.'],
    'du houmous': ['Dans un robot culinaire, mélanger les pois chiches, le tahini, le jus de citron, l\'ail, l\'huile d\'olive et le paprika jusqu\'à ce que le mélange soit lisse. Ajouter un peu d\'eau pour obtenir la consistance désirée.'],
    'des falafels': ['Mixer des pois chiches cuits avec de l\'ail, des oignons, de la coriandre, du cumin et de la farine.', 'Former des boules et les faire frire dans de l\'huile.', 'Servir chaud avec de la sauce au yaourt ou du houmous.'],
    'un curry de pois chiches': ['Faire revenir les oignons et l\'ail dans de l\'huile.', 'Ajouter les épices et les pois chiches égouttés.', 'Incorporer du lait de coco et laisser mijoter pendant 10 minutes.'],
